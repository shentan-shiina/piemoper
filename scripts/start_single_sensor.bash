...
source ~/pika_ros/install/setup.bash && roslaunch sensor_tools open_single_sensor.launch serial_port:=/dev/ttyUSB50 fisheye_port:=50 camera_fps:=$camera_fps camera_width:=$camera_width camera_height:=$camera_height
